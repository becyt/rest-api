...
La API devuelve resultados en formato JSON. La documentación sobre el esquema de metadatos que devuelve el objeto JSON se encuentra [aquí](https://github.com/becyt/rest-api/blob/master/api-format.md).
